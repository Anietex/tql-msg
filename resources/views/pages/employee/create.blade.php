                        ...
                        <div class="col-md-8 mx-auto pb-5">
                            ...
                            <form method="post" action="{{route('employees.save')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('first_name') }}" id="name" name="first_name" class="form-control @error('first_name') is-invalid @enderror">
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('last_name') }}" id="name" name="last_name" class="form-control @error('last_name') is-invalid @enderror">
                                            @error('last_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" value="{{ old('phone_no') }}" id="phone" name="phone_no" class="form-control @error('phone_no') is-invalid @enderror">
                                    @error('phone_no')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" value="{{ old('email') }}" name="email" class="form-control @error('email') is-invalid @enderror">
                                    @error('email')
